...
export async function initializeJitsiInstance(roomCode, username, jitsiContainerElement, onConferenceEndedCallback, onConferenceErrorCallback) {
    ...
    const options = {
        ...
        configOverwrite: {
            ...
            resolution: 720, // From .tsx
            constraints: { // From .tsx
                video: {
            ...
            openBridgeChannel: true, // Ensure connection is open
            doNotDisplayLobbyChat: true, // Hide any lobby-related chat
            tokenAuthUrl: null, // No authentication server
            readOnlyName: true, // Name is provided, not editable within Jitsi
            disableModeratorIndicator: true, // Prevent any implied moderation
            analytics: { disabled: true }, // Disable analytics to minimize external calls
            ...
            e2ee: { enabled: false }, // Crucial for public rooms without JWT auth
            inviteMore: false,
            peopleEnabled: false,
